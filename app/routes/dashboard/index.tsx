          ...
          <div className="px-4 lg:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              <div className="rounded-xl p-6 border border-neutral-700/50" style={{ backgroundColor: '#1a1a1a' }}>
                ...
                <p className="text-sm text-neutral-400">+3 this week</p>
              </div>
              ...
              <div className="rounded-xl p-6 border border-neutral-700/50" style={{ backgroundColor: '#1a1a1a' }}>
                ...
                <p className="text-sm text-neutral-400">+5% improvement</p>
              </div>
              ...
              <div className="rounded-xl p-6 border border-neutral-700/50" style={{ backgroundColor: '#1a1a1a' }}>
                ...
                <p className="text-sm text-neutral-400">2 more to unlock</p>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-400">Merging rules</p>
                  </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-400">Hiding rules</p>
                  </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-400">Echoing rules</p>
                  </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-400">Nasalization</p>
                  </div>
